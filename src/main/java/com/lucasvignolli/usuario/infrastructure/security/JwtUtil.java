package com.lucasvignolli.usuario.infrastructure.security;
...
public class JwtUtil {
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .signWith(getSecreKey()) // Converte a chave secreta em bytes e assina o token com ela
    ...
    public Claims extractClaims(String token) {
        return Jwts.parser()
                .verifyWith(getSecreKey()) // Define a chave secreta para validar a assinatura do token
                .build()
